"""
Windmill 워크플로우 통합 엔드포인트 (WIKISOFT4)
...
# 로거
secure_logger = structlog.get_logger("windmill")
...
async def trigger_workflow(
    ...
    ```
    result = POST /api/v4/windmill/trigger (file, sheet_type)
...
RUN_LOG_PATH = Path(__file__).parent.parent.parent.parent / "training_data" / "windmill_runs.xlsx"
