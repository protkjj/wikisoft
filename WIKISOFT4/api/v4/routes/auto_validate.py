...
from core.agent.confidence import detect_anomalies, estimate_confidence
from core.agent.tool_registry import get_registry
from core.agent.react_agent import create_react_agent
from core.ai.diagnostic_questions import format_answers_for_ai
from core.generators.report import generate_excel_report, generate_final_data_excel
from core.memory.case_store import save_successful_case
from core.memory.session_store import session_store
from core.utils.security import validate_upload_file, secure_logger
...
async def auto_validate(
    ...
    # from core.agent.tool_registry import mask_personal_info
    # 마스킹 없이 원본 데이터 사용
