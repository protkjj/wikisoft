"""
Validator 테스트 (Layer 1 & Layer 2) - WIKISOFT4
"""
import pytest
import pandas as pd
import sys
...
class TestValidationLayer1:
    ...
    def test_missing_required_column(self):
        ...
        # WIKISOFT4에서는 필수 컬럼 누락 시 에러 또는 경고
        errors = result.get("errors", [])
        warnings = result.get("warnings", [])
        # 에러 또는 경고가 있거나, 결과가 반환되면 OK
...
class TestValidationLayer2:
    ...
    def test_auto_calculate_total_retired(self):
        ...
        chatbot_answers = {"q24": 2, "q25": 5, "q26": 1}
