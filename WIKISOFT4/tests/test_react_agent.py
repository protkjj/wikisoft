"""
ReACT Agent 및 재시도 전략 테스트 (WIKISOFT4)
"""
import pytest
import sys
import os
...
from core.agent.react_agent import ReactAgent, AgentAction, AgentState, create_react_agent
from core.agent.retry_strategies import (
...
class TestReactAgent:
    ...
    def test_agent_run_with_valid_data(self, agent):
        ...
        assert result["status"] in ["completed", "needs_human", "failed", "running"]
